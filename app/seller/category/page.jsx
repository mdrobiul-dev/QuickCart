...
const CategoryManager = () => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch('http://localhost:5000/api/v1/category/getcategories');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5000/api/v1/category/createcategory', {
        method: 'POST',
        body: formData,
      });
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="border rounded p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <p className="text-base font-medium mb-2">Category Image (Required)</p>
          ...
          {categories.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {categories.map((category) => (
                <div key={category._id} className="border rounded p-3 flex items-center gap-3">
