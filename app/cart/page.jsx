...
const Cart = () => {
  const { products, router, cartItems, updateCartQuantity, getCartCount, getCartAmount, cartLoading } = useAppContext();
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row gap-10 px-6 md:px-16 lg:px-32 pt-14 mb-20">
                        ...
                        <tr key={itemId}>
                          ...
                          <td className="py-4 md:px-4 px-1">
                            <div className="flex items-center md:gap-2 gap-1">
                              ...
                              <span className="w-8 text-center border py-1">{cartItems[itemId]}</span>
                              <button 
                                onClick={() => updateCartQuantity(product._id, cartItems[itemId] + 1)}
                                disabled={cartLoading}
                              >
        ...
        <OrderSummary totalAmount={getCartAmount()} />
      </div>
    </>
  );
};
